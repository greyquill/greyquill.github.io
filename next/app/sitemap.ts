...
const ROUTES: Entry[] = [
  ...
  { path: '/products/govern',           changeFrequency: 'monthly', priority: 0.8 },
  { path: '/products/agents',           changeFrequency: 'monthly', priority: 0.8 },
  { path: '/products/gst-copilot',      changeFrequency: 'monthly', priority: 0.8 },
  { path: '/products/clarity-ai',       changeFrequency: 'monthly', priority: 0.6 },
  { path: '/services',                  changeFrequency: 'monthly', priority: 0.85 },
  { path: '/services/product-engineering',   changeFrequency: 'monthly', priority: 0.8 },
  { path: '/services/digital-transformation', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/services/ai-and-data',           changeFrequency: 'monthly', priority: 0.8 },
